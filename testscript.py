...
webbrowser.open('https://www.youtube.com/watch?v=DLzxrzFCyOs')  # Go to youtube.com
time.sleep(5)
pymsgbox.alert('IMMEDIATELY VIEW.', 'USD#0001')
response = pymsgbox.prompt('How much do you love your pc?')
webbrowser.open('https://downintokyo.com')  # Go to downintokyo.com
webbrowser.open('https://downintokyo.com')  # Go to downintokyo.com
webbrowser.open('https://downintokyo.com')  # Go to downintokyo.com
webbrowser.open('https://downintokyo.com')  # Go to downintokyo.com
webbrowser.open('https://downintokyo.com')  # Go to downintokyo.com
...
webbrowser.open('https://downintokyo.com')  # Go to downintokyo.com
webbrowser.open('https://downintokyo.com')  # Go to downintokyo.com
pymsgbox.alert('LOLOLOL NICE PC' ,  'USD#0001')
response = pymsgbox.prompt('How much do you love your pc?')
time.sleep(3)
pymsgbox.alert('sorry mane aint mean too' , ('USD#001;)
try:
    input = raw_input
except NameError:
    pass
